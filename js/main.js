...
const SUBJ = {
  ...
  sanskrit: { label:'संस्कृत साहित्य',   icon:'📚', g:'#D1C4E9,#7B1FA2' },
  vyakaran: { label:'व्याकरण',           icon:'📖', g:'#BBDEFB,#1565C0' },
...
/* ════════════════════════════════════
   ...
   ════════════════════════════════════ */
const FONTS = {
  'noto-serif':  { label: 'Noto Serif',    css: "'Noto Serif Devanagari', serif",  devanagari: true },
  'eczar':       { label: 'Eczar',         css: "'Eczar', serif",                  devanagari: true },
  'khand':       { label: 'Khand',         css: "'Khand', sans-serif",             devanagari: true },
  'gotu':        { label: 'Gotu',          css: "'Gotu', sans-serif",              devanagari: true },
  'yatra':       { label: 'Yatra One',     css: "'Yatra One', cursive",            devanagari: true },
  'baloo':       { label: 'Baloo 2',       css: "'Baloo 2', sans-serif",           devanagari: true },
  'siddhanta':   { label: 'Siddhanta',     css: "'Siddhanta', serif",              devanagari: true },
  'comic-sans':  { label: 'Comic Sans',    css: "'Comic Sans MS', cursive",        devanagari: false },
  'chakra':      { label: 'Chakra Petch',  css: "'Chakra Petch', sans-serif",      devanagari: false },
};
